...
const DashboardPage = () => {
        ...
        <Card>
          ...
          <CardActions>
            <Button
              ...
              onClick={() => navigate.push('/app/schedules')}
            >
              See Bookings
            </Button>
          </CardActions>
        ...
        <Card>
          ...
          <CardActions>
            <Button
              ...
              size="small"
              endIcon={<ArrowRightAltIcon />}
              onClick={() => navigate.push('/app/parts')}
            >
              See Parts
            </Button>
          </CardActions>
        ...
        <Card>
          ...
          <CardActions>
            <Button
              ...
              size="small"
              endIcon={<ArrowRightAltIcon />}
              onClick={() => navigate.push('/app/users')}
            >
              See Users
            </Button>
          </CardActions>
        ...
        <Card>
          ...
          <CardActions>
            <Button
              ...
              size="small"
              endIcon={<ArrowRightAltIcon />}
              onClick={() => navigate.push('/app/services')}
            >
              See Services
            </Button>
          </CardActions>
  ...
  return (
    <React.Fragment>
      ...
      {isAdmin ? renderAdminContent() : <Grid container>Client Content</Grid>}
    </React.Fragment>
  )
}
